...
using CadastroWebMvc.Models.Enums;
...
namespace CadastroWebMvc.Data
{
    ...
    {
        private CadastroWebMvcContext _context;

        public SeedingService(CadastroWebMvcContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Department d3 = new Department("Hardware");
            Department d4 = new Department("Nerds");

            Seller s1 = new Seller("Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller("João Carlos", "joao@gamil.com", new DateTime(1993, 5, 20), 1.500, d2);
            Seller s3 = new Seller("Maria Silva", "maria@gmail.com", new DateTime(1999, 8, 21), 1550, d3);
            Seller s4 = new Seller("Luna Candido", "luna@gmail.com", new DateTime(2000, 7, 20), 1500, d4);
            Seller s5 = new Seller("Lucas Matos", "lucas@gmail.com", new DateTime(1991, 6, 22), 1000.0, d1);
            Seller s6 = new Seller("Carlos Silva", "carlos@gamil.com", new DateTime(1990, 8, 20), 1.500, d4);
            ...
            //EntityFrameWork AddRange: adiciona varios objetos de uma só vez
            ...
            _context.SaveChanges(); //Salva e confirma as alterações do BD 
        }
    }
}
